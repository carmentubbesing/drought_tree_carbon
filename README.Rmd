...
| `relNO_tot` | Estimated number of dead trees in pixel | Number of dead trees from `drought` (`Pol.NO_TREE`), divied up based on `live_ratio`, which is the ratio of live trees in that pixel to total live trees in the polygon |
...
| `Pol_2013` | ADS Polygon ID for the trees that were recorded dead in 2013 | `drought` |
| `Pol_2014` | ADS Polygon ID for the trees that were recorded dead in 2014 | `drought` |
| `Pol_2015` | ADS Polygon ID for the trees that were recorded dead in 2015 | `drought` |
| `Pol_2016` | ADS Polygon ID for the trees that were recorded dead in 2016 | `drought` |
| `Pol_2017` | ADS Polygon ID for the trees that were recorded dead in 2017 | `drought` |
