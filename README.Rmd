...
| `relNO_tot` | Estimated number of dead trees in pixel | Number of dead trees from `ADS` (`Pol.NO_TREE`), divied up based on `live_ratio`, which is the ratio of live trees in that pixel to total live trees in the polygon |
