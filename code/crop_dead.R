crop_dead <- function(){
  ...
  load(paste("../results/temp/", layer, "_2013_2017.Rdata", sep = ""))
...
+ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs")  )
  ...
  save(df, file = paste("../results/temp/", layer, "_2013_2017_mask",".Rdata",sep = ""))
  save(spdf_in_unit, file = paste("../results/temp/", layer, "_2013_2017_mask_spdf",".Rdata",sep = ""))
}