crop_dead <- function(){
  ...
  load(paste("../results/", layer, "_allyears.Rdata", sep = ""))
...
+ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs")  )
  ...
  save(df, file = paste("../results/", layer, "_allyears_mask",".Rdata",sep = ""))
  save(spdf_in_unit, file = paste("../results/", layer, "_allyears_mask_spdf",".Rdata",sep = ""))
}