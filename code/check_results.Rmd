...
```{r}
sum_years <- sum(na.omit(df2013$D_BM_kg)) + sum(na.omit(df2014$D_BM_kg)) + sum(na.omit(df2015$D_BM_kg)) + sum(na.omit(spdf2015@data$D_BM_kg)) + sum(na.omit(df2017$D_BM_kg))
sum_years
...
max(df$Percent_Mortality_Biomass > 100)==FALSE
```
